                ...
                <div class="col s12 m6">
                    <div class="card blue-white lighten-1"> 
                        <div class="card-content black-text">
                            ...
                            <br>
                            <b>Create Password:</b> <span style="padding-left:60px">
                            ...
                            <br> 
                            <button class="btn waves-effect waves- light-blue darken-4" type="submit" name="action" onclick="validatePassword()">Create Account!
                            </button>
                            <br>
                        </div>
                    </div>
