     ...
     <div class="row">
        <div class="input-field col s6">
          <textarea rows="6" cols="300" id="content" name="content" class="materialize-textarea">
             ...
             <button class="btn waves-effect waves- light-blue darken-4" type="submit" name="action">SEND
            </button>
</div></div></div></div>
        </form>
         <div class="row">
            <div class="col s12 m6">
             <div class="card blue-white lighten-1"> 
                    <div class="card-content black-text">
                        <a href="InboxView">Go to Inbox</a><a href="LogoutServlet"> | Logout</a></div></div></div></div>
    </body>
</html>
